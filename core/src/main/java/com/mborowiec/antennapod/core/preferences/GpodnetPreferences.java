...
public class GpodnetPreferences {
    ...
    private static final String PREF_GPODNET_USERNAME = "com.mborowiec.antennapod.preferences.gpoddernet.username";
    private static final String PREF_GPODNET_PASSWORD = "com.mborowiec.antennapod.preferences.gpoddernet.password";
    private static final String PREF_GPODNET_DEVICEID = "com.mborowiec.antennapod.preferences.gpoddernet.deviceID";
