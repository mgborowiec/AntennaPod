package com.mborowiec.antennapod.core.util.playback;
...
import com.mborowiec.antennapod.core.service.playback.PlaybackServiceMediaPlayer;
...
import com.mborowiec.antennapod.core.util.playback.Playable.PlayableUtils;
            ...
            .subscribe(media -> {
                if (media.getMediaType() == MediaType.AUDIO) {
                    getPlayButton().setImageResource(
                            ThemeUtils.getDrawableFromAttr(activity, com.mborowiec.antennapod.core.R.attr.av_play));
                } else {
