...
public class RenameFeedDialog {
    ...
    public void show() {
        ...
        AlertDialog dialog = new AlertDialog.Builder(activity)
                .setView(content)
                .setTitle(com.mborowiec.antennapod.core.R.string.rename_feed_label)
                .setPositiveButton(android.R.string.ok, (d, input) -> {
                    feed.setCustomTitle(editText.getText().toString());
                    DBWriter.setFeedCustomTitle(feed);
                })
                .setNeutralButton(com.mborowiec.antennapod.core.R.string.reset, null)
                .setNegativeButton(com.mborowiec.antennapod.core.R.string.cancel_label, null)
                .show();
